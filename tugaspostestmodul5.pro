...
PREDICATES
nondeterm mhs(nama_matkul,nama_mahasiswa,jenis_kelamin,nim,alamat_asal) % mahasiswa dgn argumen nama_matkul,nama_mahasiswa,jenis_kelamin,nim,alamat_asal dgn jawaban bisa lebih dari satu
